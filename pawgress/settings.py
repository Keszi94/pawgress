"""
Django settings for pawgress project.
...
# Only for the amiresponsive website testing
X_FRAME_OPTIONS = 'ALLOWALL'

ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'pawgress-by-keszi94-02abbb46130d.herokuapp.com',]
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'Pawgress <{}>'.format(EMAIL_HOST_USER)
